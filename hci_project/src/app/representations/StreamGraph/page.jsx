...
import {StreamGraphShapeTransition} from "@/app/graphs/StreamGraph/StreamGraphShapeTransition";
    ...
    return (
        <div ref={parentRef}>
            <p className="text-3xl text-zinc-600 mb-3 ">Titolo del grafico: <a
                className="underline decoration-pink-500">Dio Cane</a></p>
            ...
            <div className="flex justify-center">
                <StreamGraphShapeTransition  width={width} height={500}/>
            </div>
        </div>
    );
}
